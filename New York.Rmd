...
ny_zone_e <- st_read("/Users/jakeford/Library/CloudStorage/GoogleDrive-jake@solstice.us/Shared drives/Product | Jake/Geocoding/New York/Zone E Boundary/NY Zone E.shp") 
...
temp %>%
  filter(Name=="Total") %>%
  write_csv("docs/final_data/ny_geo_total.csv")
...
temp_table %>%
  ...
  write_csv("docs/final_data/ny_lmi_total.csv")

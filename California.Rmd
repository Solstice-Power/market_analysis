...
# 2. add CS saturation layer - how much current CS is in the market currently? i
...
env_df <- st_read("/Users/jakeford/Library/CloudStorage/GoogleDrive-jake@solstice.us/Shared drives/Product | Jake/Geocoding/Qualified LMI by Utility Zones/lmi_by_utility/docs/data/CA/calenviroscreen40shpf2021shp/CES4 Final Shapefile.shp") 
...
temp_table %>%
  ...
  write_csv("docs/final_data/ca_geo_total.csv")
...
temp_table %>%
  filter(Utility=="Total") %>%
  write_csv("docs/final_data/ca_lmi_total.csv")
